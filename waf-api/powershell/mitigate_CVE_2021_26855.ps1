...
#Write-Host "Invoke-WebRequest -Uri $loginurl -Method Post -Body $loginBodyJSON -ContentType $contentType -SkipCertificateCheck"
...
$bodyJSON = $postbody | ConvertTo-Json

Write-Host "Adding ACL " $postbody.name
try {
